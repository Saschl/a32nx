    ...
    new TaskOfTasks('a32nx', [
        ...
        new TaskOfTasks(
            ...
            [
                ...
                new ExecTask('terrain-map', 'npm run build-a32nx:terrain-map', [
                    'scripts/terrain_map.js',
                    'fbw-common/src/wasm/terronnd_rs/src/convert.rs',
                    'fbw-common/src/wasm/terronnd_rs/src/fileformat.rs',
                    'fbw-common/src/wasm/terronnd_rs/src/fileformat_v2.rs',
                    'fbw-common/src/wasm/terronnd_rs/src/bin',
                    'fbw-a32nx/out/flybywire-aircraft-a320-neo/terrain/terrain2.map',
                ]),
            ],
            false,
        ),
        ...
        new TaskOfTasks(
            ...
            [
                ...
                new ExecTask(
                    ...
                    [
                        'fbw-common/src/wasm/terronnd_rs',
                        'Cargo.lock',
                        'Cargo.toml',
    ...
    new TaskOfTasks('a380x', [
        new TaskOfTasks(
            ...
            [
                ...
                new ExecTask('terrain-map', 'npm run build-a380x:terrain-map', [
                    'scripts/terrain_map.js',
                    'fbw-common/src/wasm/terronnd_rs/src/convert.rs',
                    'fbw-common/src/wasm/terronnd_rs/src/fileformat.rs',
                    'fbw-common/src/wasm/terronnd_rs/src/fileformat_v2.rs',
                    'fbw-common/src/wasm/terronnd_rs/src/bin',
                    'fbw-a380x/out/flybywire-aircraft-a380-842/terrain/terrain2.map',
                ]),
            ],
            false,
        ),
